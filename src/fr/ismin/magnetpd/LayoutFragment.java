...
public class LayoutFragment extends Fragment {
	...
	private static final String TAG = "LayoutFragment";
	   ...
	   public void initGUI(){
			...
			magnStrengthTextView = ((ImageView) view.findViewById(R.id.magn_strength));
		...
		protected void rotate(float x) {
			...
			RotateAnimation rotation = new RotateAnimation((float) degrees, (float) alpha, RotateAnimation.RELATIVE_TO_SELF , (float) 0.5, RotateAnimation.RELATIVE_TO_SELF, (float) 1.0);
